...
const VehicleDetailsPage = () => {
  ...
  const handleShare = async () => {
    const shareData = {
      title: vehicle?.title || 'Check out this vehicle',
      text: `${vehicle?.title} - ${vehicle?.description?.substring(0, 100)}...`,
    ...
    try {
      ...
      if (error instanceof Error && error.name !== 'AbortError') {
        try {
          ...
          toast.error('Failed to share vehicle');
        }
      }
    }
  };
          ...
          <div className='space-y-6'>
            ...
            <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700'>
              ...
              <div className='space-y-3'>
                ...
                <button onClick={handleShare} className='w-full border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2'>
